...
LEXICON_ANSWERS_RU = {
    ...
    'admin_not_find_user': "Данный пользователь не найден, отправь телеграм id/username пользователя или поделись его контактом",
    ...
    'start_mini_app_find': 'Нажмите на кнопку, чтобы настроить поиск',
    'start_mini_app_dossier': 'Нажмите на кнопку, чтобы настроить досье'
}
...
LEXICON_BUTTONS_RU = {
    ...
    'start_mini_app': "🚀 Запустить"
}

LEXICON_URLS_RU = {'mini_app': 'https://google.com'}